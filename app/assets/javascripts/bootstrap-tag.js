...
!function ( $ ) {
  ...
  , inTypeahead: function ( value ) {
      if (this.options.caseInsensitive) {
        var index = -1
        $.each(this.options.source, function (indexInArray, valueOfElement) {
          if ( valueOfElement.toLowerCase() == value.toLowerCase() ) {
            index = indexInArray
            return false
          }
  ...
  , add: function ( value ) {
      ...
      if((that.inTypeahead(value)!= -1 && !that.options.allowNew) || that.options.allowNew)
      {
