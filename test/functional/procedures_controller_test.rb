...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { date: @procedure.date, procedure: @procedure.procedure, remarks: @procedure.remarks, tooth_no: @procedure.tooth_no }
    end
  ...
  test "should update procedure" do
    put :update, id: @procedure, procedure: { date: @procedure.date, procedure: @procedure.procedure, remarks: @procedure.remarks, tooth_no: @procedure.tooth_no }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
